...
// FIXME: temporary, while backend it's not developed
const products: IProduct[] = [
    ...
    },
    {
        ...
        description: 'The Dell G5 offers a smooth gaming experience and high-quality graphics.',
        brand: 'Dell',
        model: 'G5-5590-A30B',
    ...
    },
    {
        ...
        description:
            'The Lenovo Legion Y540 is a high-performance gaming laptop with an elegant design.',
        brand: 'Lenovo',
    ...
    },
    {
        ...
        description:
            'The HP Pavilion is a gaming laptop with solid performance and modern design, perfect for gamers seeking cost-effectiveness.',
        brand: 'HP',
    ...
    },
    {
        ...
        description:
            'The MSI GL65 Leopard offers superior performance with an aggressive design and customizable RGB keyboard.',
        brand: 'MSI',
    ...
    },
    {
        ...
        description:
            'The Razer Blade 15 is a premium gaming laptop with an ultra-thin design and cutting-edge hardware.',
        brand: 'Razer',
        model: 'Blade 15 Base',
    ...
    },
    {
        ...
        description:
            'Enjoy supersonic speeds with 8 cores and 16 processing threads, ready to tackle the most challenging titles. Base frequency of 3.0GHz and dynamic boost up to 4.1GHz to eliminate any stuttering.',
        brand: 'AMD',
        ...
        tags: ['Interest-free', 'Best Sellers', 'Cost-Effective'],
        basePrice: 2499.99,
    ...
    },
    {
        ...
        description:
            'The AMD Ryzen 9 7950X3D processor redefines gaming and productivity performance, with 16 cores and 32 threads and a total cache of 128MB. Boost frequency up to 5.7 GHz, ideal for intensive workloads and multitasking.',
        brand: 'AMD',
        ...
        tags: ['Extreme Performance', 'Top of the Line', 'Gamer'],
        basePrice: 5899.99,
    ...
    },
    {
        ...
        description:
            'The Razer BlackWidow V3 is equipped with Razer Green mechanical switches for precise tactile response and satisfying audible feedback. It features Razer Chroma RGB lighting and an aluminum frame for increased durability.',
        brand: 'Razer',
    ...
    },
    {
        ...
        description:
            'With Cherry MX Red switches, the Corsair K70 RGB MK.2 offers linear and silent response. Built with brushed aluminum, ideal for long gaming sessions, and with dynamic RGB lighting.',
        brand: 'Corsair',
        model: 'CH-9109010-NA',
        ...
        tags: ['Dynamic RGB', 'Aluminum Structure', 'Silent Switch'],
        basePrice: 1799.99,
    ...
    },
    {
        ...
        description:
            'The Redragon Draconic K530 is a compact, wireless mechanical keyboard designed for maximum portability and performance. Equipped with Outemu Brown switches, ideal for those seeking a balance between tactile feedback and silence, plus Bluetooth connectivity.',
        brand: 'Redragon',
        model: 'K530-RGB',
    ...
    },
    {
        ...
        description:
            'The Razer DeathAdder V2 features the 20,000 DPI Focus+ optical sensor, with optical switches for faster clicks and durability of up to 70 million clicks. Ergonomic and lightweight design, with SpeedFlex cable for drag-free movements.',
        brand: 'Razer',
        ...
        specifications: {
            ...
            'Maximum DPI': 20000,
            Connectivity: 'SpeedFlex USB Cable',
    ...
    },
    {
        ...
        description:
            'The HyperX Pulsefire FPS Pro is ideal for gamers seeking precision and comfort. Equipped with the Pixart 3389 sensor of up to 16,000 DPI and Omron buttons with high durability. Customizable RGB lighting and ergonomic design.',
        brand: 'HyperX',
        model: 'HX-MC003B',
    ...
    },
    {
        ...
        tags: ['Comfortable', '7.1 Surround', 'Detachable Microphone'],
        basePrice: 899.99,
    ...
    },
    {
        ...
        description:
            'The Razer Kraken X is an ultra-lightweight headset with 7.1 surround sound and memory foam ear cushions for maximum comfort. Cardioid microphone and reinforced structure for durability.',
        brand: 'Razer',
        ...
        tags: ['Lightweight', '7.1 Surround', 'Flexible Microphone'],
        basePrice: 299.99,
        promotionalPrice: 229.99,
        lowestPrice: 199.99,
        highestPrice: 349.99,
        averagePrice: 269.99,         specifications: {
          highlight: 'Virtual 7.1 Surround',
          Drivers: '40mm',
  ...
  },
  {
      ...
      description:
          "The Samsung Odyssey G7 has a 240Hz refresh rate and 1ms response time. With a curved QHD panel and G-Sync technology, it's ideal for gamers seeking performance and immersion.",
      brand: 'Samsung',
  ...
  },
  {
      ...
      description:
          'The RTX 3060 Ventus 2X MSI is equipped with 12GB GDDR6, offering cutting-edge performance for 4K gaming and Ray Tracing. It supports DLSS and advanced NVIDIA technologies for maximum performance.',
      brand: 'MSI',
  ...
  },
  {
      ...
      description:
          'The RX 6800 XT features 16GB GDDR6 and RDNA 2 architecture, providing excellent performance in 1440p and 4K gaming. Includes support for Ray Tracing and Smart Access Memory technology for Ryzen CPUs.',
      brand: 'ASRock',
  ...
  },
  {
      ...
      description:
          'The ROG Strix Z590-E is a premium motherboard for 11th generation Intel processors, with support for overclocking, integrated Wi-Fi 6E, and ASUS Aura Sync RGB lighting.',
      brand: 'ASUS',
  ...
  },
  {
      ...
      tags: ['PCIe 4.0', 'Advanced Cooling', 'Ryzen Support'],
      basePrice: 1399.99,
      promotionalPrice: 999.99,
      lowestPrice: 899.99,
      highestPrice: 1599.99,
  ...
  },
  {
      ...
      description:
          "The Kingston Fury Beast is designed for users who need extra capacity. With 32GB and 3200MHz frequency, it's ideal for advanced multitasking and heavy gaming, maintaining low latency.",
      brand: 'Kingston',
